...
import 'package:gerencia_estado_provider/data/store.dart';
import 'package:gerencia_estado_provider/exceptions/auth_exception.dart';
import 'package:http/http.dart' as http;

//link doc: https://firebase.google.com/docs/reference/rest/auth?hl=en
...
class Auth with ChangeNotifier {
  ...
  Future<dynamic> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=AIzaSyBz6Osu6M8BAE2fdsd-0Qi9kUOW2HdnmpE';
